...
export const TabSelector = ({ isActive, children, onClick }) => (
  <button
    className={`btn btn-link text-decoration-none text-reset shadow-none semi-bold-text mr-4 px-2 inline-flex items-center py-2 font-medium cursor-pointer whitespace-nowrap tab-button ${
      isActive
