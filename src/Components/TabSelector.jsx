...
export const TabSelector = ({ isActive, children, onClick }) => (
  <button
    className={`btn btn-link text-decoration-none text-reset shadow-none font-weight-bold mr-4 inline-flex items-center px-2 py-2 font-medium cursor-pointer whitespace-nowrap tab-button ${
      isActive
